...
def fetch_actual_price(output_file):
    urls = {
...
if not os.path.exists(output_file):
    df = fetch_actual_price(output_file)
else:
...
metrics.to_csv('data/average_metrics.csv')


# TODO: I can add here the code to calculate evolution, so we use the notebook just for plotting and analysis
